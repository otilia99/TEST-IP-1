function retrievePostInfoLinkedin() {
    ...
    invocation.onreadystatechange = function() {
        if (tempo == 4) {
            ...
            modifyHTMLLinkedin(obj.id, obj.comments_count, obj.created_at, obj.likes, obj.shares, obj.text);
    ...
    function modifyHTMLLinkedin(id, comments_count, created_at, likes, shares, text) {
